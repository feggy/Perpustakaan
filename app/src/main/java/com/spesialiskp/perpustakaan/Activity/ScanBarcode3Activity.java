...
public class ScanBarcode3Activity extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    ...
    public void handleResult(Result rawResult) {
        ...
        Intent i = new Intent(ScanBarcode3Activity.this, PerpanjangActivity.class);
        i.putExtras(bundle);
